...
<Card title="Search Practices" icon="magnifying-glass" href="/api-reference/endpoints/search-practices">
  Search and submit via LD5 pipeline
</Card>

<Card title="Create Job" icon="file-csv" href="/api-reference/endpoints/create-job">
...
<Card title="Get Job Users" icon="users" href="/api-reference/endpoints/get-job-users">
  Fetch user emails
</Card>
