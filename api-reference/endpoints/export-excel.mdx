...
See [Data Extraction](/architecture/data-extraction) for detailed field mapping and priority rules.
...
<Card title="Export as CSV" icon="file-csv" href="/api-reference/endpoints/export-job">
  Export job data as CSV file
</Card>

<Card title="Export as JSON" icon="code" href="/api-reference/endpoints/export-json">
  Export raw JSON data
</Card>

<Card title="Get Job Detail" icon="list" href="/api-reference/endpoints/get-job">
  Retrieve job information
</Card>

<Card title="List Jobs" icon="table" href="/api-reference/endpoints/list-jobs">
  View all user jobs
</Card>
