...
<Steps>
  <Step title="Fetch Page Content">
    Retrieve HTML from the normalized URL
  </Step>
...
<Card title="Aggregator Worker" icon="layer-group" href="/workflows/aggregator-worker">
  Combine data into final payload
</Card>

<Card title="OpenAI Best Practices" icon="brain" href="/workflows/overview">
